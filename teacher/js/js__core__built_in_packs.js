    ...
    return {
      ...
      activities: [
        ...
        /* ---------- Section 4: Test & visualise ---------- */
        {
          ...
          instructions: "check_name returns \"VALID\" when the name length is allowed, otherwise \"NOT VALID\". Some rows give a value (work out the type of test); some give the type (give a value of that kind). Complete the highlighted cells.",
    ...
    return {
      ...
      activities: [
        ...
        /* ---------- Test & visualise ---------- */
        {
          ...
          instructions: "is_valid returns True when the score is within 0..1000, otherwise False. Some rows give a value (work out the type of test); some give the type (give a value of that kind). Complete the highlighted cells.",
    ...
    return {
      ...
      activities: [
        ...
        /* ---------- Test & visualise ---------- */
        {
          ...
          instructions: "sum_to returns the total of 0..n when n is within 0..1000, otherwise it returns -1. Some rows give a value (work out the type of test); some give the type (give a value of that kind). Complete the highlighted cells.",
