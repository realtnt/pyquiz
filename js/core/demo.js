    ...
    pack: {
      ...
      activities: [
        ...
        },
        {
          ...
          payload: {
            lines: [
              { id: "a", code: "def count_vowels(text):", indent: 0, distractor: false, fixed: false },
              { id: "b", code: "vowels = \"aeiou\"", indent: 1, distractor: false, fixed: false },
              { id: "c", code: "count = 0", indent: 1, distractor: false, fixed: false },
              { id: "d", code: "for ch in text:", indent: 1, distractor: false, fixed: false },
              { id: "e", code: "if ch.lower() in vowels:", indent: 2, distractor: false, fixed: false },
              { id: "f", code: "count = count + 1", indent: 3, distractor: false, fixed: false },
              { id: "g", code: "return count", indent: 1, distractor: false, fixed: false },
              { id: "h", code: "count = count - 1", indent: 3, distractor: true, fixed: false },
              { id: "i", code: "if ch in vowels:", indent: 2, distractor: true, fixed: false }
            ],
            solution: ["a", "b", "c", "d", "e", "f", "g"],
            indent_baked_in: true,
            indent_size_spaces: 4,
            runner_call: "print(count_vowels(\"Hello World\"))"
          }
        },
