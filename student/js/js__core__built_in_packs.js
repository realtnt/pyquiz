 ...
 *   topics, skills, exam_refs, primm_phase,
...
(function () {
  ...
  A.push({
    ...
    exam_refs: [], primm_phase: "investigate", concept_level: "introduce",
  ...
  A.push({
    ...
    exam_refs: [], primm_phase: "investigate", concept_level: "practise",
  ...
  A.push({
    ...
    exam_refs: [], primm_phase: "investigate", concept_level: "consolidate",
  ...
  A.push({
    ...
    exam_refs: [], primm_phase: "investigate", concept_level: "extend",
    hints: [
   ...
   * Public registry
   * ===================================================================== */
  function packFlowchartStressHand() { return {
  "pack_format_version": "0.1",
  "schema_version": "0.1",
  "id": "builtin-flowchart-stress-hand",
  "title": "Flowchart Workout (24) — hand-routed",
  "description": "Twenty-four flowchart-completion activities of rising difficulty: linear, decisions, nested decisions, counting and conditional loops, validation, and nested loops. This copy keeps the teacher's hand-tuned edge routing (explicit sides and bends).",
  "language": "python",
  "audience": "ages-14-16",
  "created_at": "2026-05-28T00:00:00Z",
  "updated_at": "2026-05-29T09:36:45.225Z",
  "tags": [
    "builtin",
    "flowchart",
    "stress-test"
  ...
  "settings": {
    ...
    "show_solutions_after": "submission",
    "pass_threshold": 0.7,
    "show_runner_after": "never",
    "ask_confidence": false,
    "attempts_per_activity": 2,
    "sequential": false
  },
  "sections": [
    {
  ...
  "activities": [
    {
      ...
      "exam_refs": [],
      "primm_phase": "investigate",
      "concept_level": "introduce",
      "hints": [
        {
          "type": "nudge",
          "text": "Two numbers appear in the description: the starting value and the amount added."
        }
      ],
      "feedback": {
        "correct": "Good — a straight run of steps, top to bottom.",
        "incorrect": "Re-read: the score starts at one number and has another added to it."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "Doubling a number is the same as multiplying it by 2."
        }
      ],
      "feedback": {
        "correct": "Right — n times 2 doubles it.",
        "incorrect": "To double n you multiply it by 2."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "exam_refs": [],
      "primm_phase": "investigate",
      "concept_level": "practise",
      "hints": [
        {
          "type": "concept",
          "text": "'50 or more' means greater-than-or-equal. The Yes branch is taken when the condition is true."
        }
      ],
      "feedback": {
        "correct": "Right — the diamond decides which message is shown.",
        "incorrect": "The condition decides the branch. Yes leads to 'pass', No leads to 'fail'."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "nudge",
          "text": "'Above 30' is a strict greater-than — 30 itself does not trigger the warning."
        }
      ],
      "feedback": {
        "correct": "Right — the No branch skips straight to the end.",
        "incorrect": "'Above 30' means strictly greater than 30."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "The loop continues while the counter is strictly less than the limit. The last value printed is 4."
        }
      ],
      "feedback": {
        "correct": "Right — i < 5 keeps going for 0,1,2,3,4 then stops.",
        "incorrect": "The last value printed is 4, and the test is strictly less-than, so the limit is one more than 4."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "exam_refs": [],
      "primm_phase": "investigate",
      "concept_level": "consolidate",
      "hints": [
        {
          "type": "concept",
          "text": "A while loop checks its condition BEFORE each pass. 'While greater than 1' continues as long as n > 1."
        }
      ],
      "feedback": {
        "correct": "Right — the loop runs while n is still greater than 1.",
        "incorrect": "The loop continues while n is greater than 1."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "An accumulator must start at 0 so the first addition is correct."
        },
        {
          "type": "nudge",
          "text": "'Less than or equal to N' includes N itself, so the operator is <=."
        }
      ],
      "feedback": {
        "correct": "Right — total starts at 0 and the loop includes N.",
        "incorrect": "The total starts at 0. The loop must include N, so the test is i <= N."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "The first diamond checks the highest band. If it fails, the second diamond checks the middle band. The final else catches everything left."
        }
      ],
      "feedback": {
        "correct": "Right — each diamond narrows the range further.",
        "incorrect": "Top diamond: score >= 70 → A. Second diamond: score >= 40 → C. Else → F."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "The remainder (modulo) operator in Python is %. A number is even when n % 2 equals 0."
        }
      ],
      "feedback": {
        "correct": "Right — n % 2 == 0 means even.",
        "incorrect": "Use the remainder operator % and compare the remainder against 0."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "nudge",
          "text": "If a is to be shown on the Yes branch, the condition must be true when a is the bigger one."
        }
      ],
      "feedback": {
        "correct": "Right — a > b sends control to 'display a'.",
        "incorrect": "For the Yes branch to display a, the test should be a > b."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "exam_refs": [],
      "primm_phase": "investigate",
      "concept_level": "extend",
      "hints": [
        {
          "type": "concept",
          "text": "The loop continues while i is strictly less than N. Inside it, i % 2 == 0 tests for even."
        },
        {
          "type": "nudge",
          "text": "Three blanks: the loop test (<), the remainder operator (%), and the value (0)."
        }
      ],
      "feedback": {
        "correct": "Right — a decision nested inside the loop body.",
        "incorrect": "Loop while i < N. Inside, test i % 2 == 0 for even."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "'Not equal to' in Python is written !=. The loop keeps going while guess != secret."
        }
      ],
      "feedback": {
        "correct": "Right — loop while the guess is wrong, stop when it matches.",
        "incorrect": "'Not equal' is !=. The loop continues while guess != secret."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "Divisible by 3 means the remainder i % 3 is 0."
        },
        {
          "type": "nudge",
          "text": "'1 to N inclusive' needs <= so N is included."
        }
      ],
      "feedback": {
        "correct": "Right — modulo test inside a counting loop.",
        "incorrect": "Loop while i <= N. Divisible by 3 is i % 3 == 0."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "The loop should repeat while the input is INVALID. An age below 0 is invalid, so the loop continues while age < 0."
        }
      ],
      "feedback": {
        "correct": "Right — re-prompt while the age is negative.",
        "incorrect": "Invalid means below zero. Loop while age < 0."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "nudge",
          "text": "The first diamond checks choice == 1, the second checks choice == 2."
        }
      ],
      "feedback": {
        "correct": "Right — a chain of equality checks.",
        "incorrect": "First diamond compares with 1, second with 2."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "'Under 16' is age < 16. '65 or over' is age >= 65."
        }
      ],
      "feedback": {
        "correct": "Right — child, senior, then standard.",
        "incorrect": "First diamond: age < 16 → 5. Second: age >= 65 → 6. Else → 9."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "nudge",
          "text": "You update the best only when the new value is bigger than it: value > best."
        }
      ],
      "feedback": {
        "correct": "Right — update best when a bigger value appears.",
        "incorrect": "Update only when value > best."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "'At most 12' means i can equal 12, so the operator is <= and the limit is 12."
        }
      ],
      "feedback": {
        "correct": "Right — runs i from 1 through 12 inclusive.",
        "incorrect": "Loop while i <= 12."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "Both conditions must hold. The first diamond checks n >= 1; only if that's true does the second check n <= 10."
        }
      ],
      "feedback": {
        "correct": "Right — both diamonds must say Yes for 'valid'.",
        "incorrect": "First diamond: n >= 1. Second: n <= 10. Either No leads to 'invalid'."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "nudge",
          "text": "Counting down means subtracting 1 each pass, starting from 5."
        }
      ],
      "feedback": {
        "correct": "Right — start at 5, subtract 1, stop at 0.",
        "incorrect": "Start = 5; each pass subtracts 1."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "Total starts at 0. Loop while i <= N. Even means i % 2 == 0."
        }
      ],
      "feedback": {
        "correct": "Right — accumulate only the evens.",
        "incorrect": "total starts 0; loop i <= N; even test i % 2 == 0."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "'Fewer than 3 attempts' is attempts < 3. 'Password wrong' is entry != password."
        }
      ],
      "feedback": {
        "correct": "Right — two guards: attempts left AND password still wrong.",
        "incorrect": "attempts < 3 and entry != password."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "Both loops use strictly-less-than: r < rows for the outer loop, c < cols for the inner loop."
        }
      ],
      "feedback": {
        "correct": "Right — an inner loop nested inside the outer one.",
        "incorrect": "Both diamonds use < (strictly less than)."
      },
      "payload": {
        "flowchart": {
          "shapes": [
    ...
    },
    {
      ...
      "hints": [
        {
          "type": "concept",
          "text": "Keep subtracting while a is still at least b — that's a >= b. Each pass subtracts b."
        }
      ],
      "feedback": {
        "correct": "Right — repeated subtraction leaves the remainder in a.",
        "incorrect": "Loop while a >= b; subtract b each pass."
      },
      "payload": {
        "flowchart": {
          "shapes": [
